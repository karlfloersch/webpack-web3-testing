...
(function() {
  ...
  var contract_data = {
    ...
    address: "0x51d8cb968be408d9e70f1d774c10ebc6f33cd597",
  ...
  function Contract() {
    if (Contract.Pudding == null) {
      throw new Error("SimpleStorage error: Please call load() first before creating new instance of this contract.");
    }
  ...
  Contract.new = function() {
    if (Contract.Pudding == null) {
      throw new Error("SimpleStorage error: Please call load() first before calling new().");
    }
  ...
  Contract.at = function() {
    if (Contract.Pudding == null) {
      throw new Error("SimpleStorage error: lease call load() first before calling at().");
    }
  ...
  Contract.deployed = function() {
    if (Contract.Pudding == null) {
      throw new Error("SimpleStorage error: Please call load() first before calling deployed().");
    }
